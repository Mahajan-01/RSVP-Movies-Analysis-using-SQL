...
-- 3289 movies belong to only and only one genre
...
WITH production_company_hit_movie_summary
     AS (SELECT production_company, Count(movie_id) AS MOVIE_COUNT, Rank()
                  OVER(
...
/* Shraddha Srinath tops with average rating 8.48. 
